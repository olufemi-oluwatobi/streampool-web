                    ...
                    <div className="w-full mt-2 flex justify-between">
                        ...
                        <span>
                            <Tag
                                ...
                                color={isPoolOwner && "magenta" || status !== "pending request" ? "green" : "volcano"}
                            >
                            ...
                            <div className="flex flex-col">
                                <div className="flex flex-col justify-start items-start">
                                    ...
                                    <div className="w-full flex mt-6 justify-between">
                                        ...
                                        <button
                                            onClick={() => {
                                                copyToClipboard(pool?.poolCredential?.account_email || pool?.poolCredential?.email?.email);
                                                triggerNotification(
                                        ...
                                        >
                                            <span className=" font-bold mr-2  text-white-200  text-md ">
                                                {pool?.poolCredential?.account_email || pool?.poolCredential?.email?.email}
                                            </span>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
